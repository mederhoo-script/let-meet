...
function toggleFileInput() {
    ...
    if (fileInput.style.display === 'none') {
        ...
        change_pic.style.display = 'inline';
    }
}

//changing story pics
function toggle_storyInput() {
    var storyInput = document.getElementById('storyInput');
    var submit_story = document.getElementById('submit_story');
    if (storyInput.style.display === 'none') {
        storyInput.style.display = 'inline';
        submit_story.style.display = 'inline';
        change_story.style.display = 'none';
    } else {
        storyInput.style.display = 'none';
        submit_story.style.display = 'none';
        change_story.style.display = 'block';
    }
}

//changing feed pics
function toggle_feedInput() {
    var feedInput = document.getElementById('feedInput');
    var submit_feed = document.getElementById('submit_feed');
    if (feedInput.style.display === 'none') {
        feedInput.style.display = 'inline';
        //submit_feed.style.display = 'inline';
        change_feed.style.display = 'none';
    } else {
        feedInput.style.display = 'none';
        submit_feed.style.display = 'none';
        change_feed.style.display = 'block';
    }
}
